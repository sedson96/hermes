        ...
        <section className="top-section">
            <div className="top-image">
                <picture>
                    ...
                    <img id="tcm:221-366310" src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/enUS/Images/running-fw19-pb-tease-clp-mh-medium-d_tcm221-366304.jpg" className="performance-item" data-inject_ssr_performance_instrument="" data-di-id="#tcm:221-366310"/>
                </picture>
            </div>
