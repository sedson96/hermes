    ...
    return (
        ...
        <div className="main-nav">
            ...
            <ul className="collapsed-link-blocks">
                ...
                <h4 className="collapsed-nav-links">Leggings &#38; Tights</h4>
                <h4 className="collapsed-nav-links">Sports Bras</h4>
                ...
                <h4 className="collapsed-nav-links">Dresses &#38; Skirts</h4>
            ...
            <ul className="collapsed-link-blocks">
                ...
                <h4 className="collapsed-nav-links">Yoga</h4>
